...
from gurobipy import GRB, Env, Model, quicksum, tupledict
...
def build_model(instance: Instance, disable_logs: bool = False) -> tuple[Model, ModelVars]:
    ...
    with Env(empty=True) as env:
        ...
        for j, first_item in enumerate(first_items):
            ...
            _addLConstr(zvars.sum(j, '*'), LEQ, svars[j] + 1, '_s')
    ...
    return ModelVars(model, xvars, yvars, zvars, svars)
