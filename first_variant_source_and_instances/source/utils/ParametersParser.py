...
DEFAULT_MOVE_ITEM = 10  # 5 # It will be multiplied by the number of items to move, so it must be low
DEFAULT_RESTART = 30  # 5 # Must decrease if the execution is slower (less iterations), otherwise it will restart a few times
